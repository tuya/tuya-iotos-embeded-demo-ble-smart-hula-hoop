...
static void tuya_cb_handler(tuya_ble_cb_evt_param_t* event)
{
    ...
    case TUYA_BLE_CB_EVT_CONNECTE_STATUS:
        ...
        hula_hoop_ble_conn_stat_handler(event->connect_status);
    ...
    case TUYA_BLE_CB_EVT_DP_WRITE:
        ...
        hula_hoop_ble_dp_write_handler(dp_data_array);
    ...
    case TUYA_BLE_CB_EVT_TIME_NORMAL:
        TUYA_APP_LOG_INFO("received timenormal : %d.%d.%d %d:%d:%d, week : %d, time_zone : %d",
        ...
        hula_hoop_ble_time_normal_handler(event->time_normal_data);
        break;
...
/**
 * @brief called by "user_init_deepRetn()"
 * @param[in] none
 * @return none
 */
